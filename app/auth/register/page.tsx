...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Redirecionar para login com mensagem de sucesso (opcional)
            ...
            <main className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
                <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 w-full max-w-md shadow-xl">
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-2xl font-bold text-slate-50">Crie sua conta</h1>
                        <p className="text-slate-400 mt-2">Comece a criar sua vitrine hoje mesmo</p>
                    </div>
